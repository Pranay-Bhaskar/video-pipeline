...
export default function SavedPage() {
  return (
    <div className="min-h-dvh bg-[#000000] pb-24">
      <div className="px-4 pt-14 pb-4">
        <h1 className="text-xl font-bold text-white">Saved</h1>
        <p className="text-sm text-[#6e6e6e] mt-1">Your saved places and videos</p>
      </div>


      <div className="flex flex-col items-center justify-center py-24 px-8 text-center">
        <div className="w-16 h-16 rounded-2xl bg-[#1a1a1a] flex items-center justify-center mb-4">
          <Bookmark className="w-8 h-8 text-[#2a2a2a]" />
        </div>
        <h2 className="text-base font-semibold text-white mb-2">Nothing saved yet</h2>
        <p className="text-sm text-[#6e6e6e]">
          Tap the bookmark icon on any video to save it here for later.
        </p>
        <div className="mt-4 bg-[#111111] border border-[#2a2a2a] rounded-xl px-4 py-2.5">
          <p className="text-xs text-white">💡 Coming in V2: Full saved places + itinerary builder</p>
        </div>
      </div>
